...
namespace InsuranceAgency.ProviderAPI.Controllers
{
    ...
    public class AkSigortaController : CustomBaseController
    {
        public AkSigortaController()
        {
        }
        ...
        public IActionResult GetIndex(Quotation quotation)
        {
            Offer offer = new()
            {
                ...
                Logo = "https://cdnsnet.mncdn.com/facelift/assets/img/elements/companies-icon/ak-sigorta.png",
