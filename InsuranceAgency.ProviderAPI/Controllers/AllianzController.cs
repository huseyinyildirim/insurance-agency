...
namespace InsuranceAgency.ProviderAPI.Controllers
{
    ...
    public class AllianzController : CustomBaseController
    {
        public AllianzController()
        {
        }
        ...
        public IActionResult GetIndex(Quotation quotation)
        {
            ...
            {
                CompanyName = "Allianz",
                Logo = "https://cdnsnet.mncdn.com/facelift/assets/img/elements/companies-icon/allianz.png",
