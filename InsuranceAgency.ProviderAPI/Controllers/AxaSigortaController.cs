...
namespace InsuranceAgency.ProviderAPI.Controllers
{
    ...
    public class AxaSigortaController : CustomBaseController
    {
        public AxaSigortaController()
        {
        }
        ...
        public IActionResult GetIndex(Quotation quotation)
        {
            Offer offer = new()
            {
                ...
                Logo = "https://cdnsnet.mncdn.com/facelift/assets/img/elements/companies-icon/axa-sigorta.png",
