...
namespace InsuranceAgency.ProviderAPI.Controllers
{
    ...
    public class DogaSigortaController : CustomBaseController
    {
        public DogaSigortaController()
        {
        }
        ...
        public IActionResult GetIndex(Quotation quotation)
        {
            Offer offer = new()
            {
                CompanyName = "Doğa Sigorta",
                Logo = "https://cdnsnet.mncdn.com/facelift/assets/img/elements/companies-icon/doga-sigorta.png",
