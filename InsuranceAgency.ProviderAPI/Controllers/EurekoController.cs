...
namespace InsuranceAgency.ProviderAPI.Controllers
{
    ...
    public class EurekoController : CustomBaseController
    {
        public EurekoController()
        {
        }
        ...
        public IActionResult GetIndex(Quotation quotation)
        {
            ...
            {
                CompanyName = "Eureko",
                Logo = "https://cdnsnet.mncdn.com/facelift/assets/img/elements/companies-icon/eureko.png",
