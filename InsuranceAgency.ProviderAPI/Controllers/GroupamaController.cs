...
namespace InsuranceAgency.ProviderAPI.Controllers
{
    ...
    public class GroupamaController : CustomBaseController
    {
        public GroupamaController()
        {
        }
        ...
        public IActionResult GetIndex(Quotation quotation)
        {
            Offer offer = new()
            {
                ...
                Logo = "https://cdnsnet.mncdn.com/facelift/assets/img/elements/companies-icon/groupama.png",
