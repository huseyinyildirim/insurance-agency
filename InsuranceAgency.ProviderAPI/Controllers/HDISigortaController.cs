...
namespace InsuranceAgency.ProviderAPI.Controllers
{
    ...
    public class HDISigortaController : CustomBaseController
    {
        public HDISigortaController()
        {
        }
        ...
        public IActionResult GetIndex(Quotation quotation)
        {
            Offer offer = new()
            {
                ...
                Logo = "https://cdnsnet.mncdn.com/facelift/assets/img/elements/companies-icon/hdi-sigorta.png",
